  ...
  <div class="login-container">
    ...
    <div class="login-box glass-card">
      <div class="login-left">
        <div class="brand">
          <div class="gdut-logo-large">
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <circle cx="50" cy="50" r="45" fill="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.5)" stroke-width="2"/>
              <text x="50" y="55" text-anchor="middle" fill="white" font-size="24" font-weight="bold">GDUT</text>
              <text x="50" y="70" text-anchor="middle" fill="rgba(255,255,255,0.8)" font-size="8">图书馆</text>
            </svg>
          </div>
          <h1>LMS</h1>
          <p>智能图书管理系统</p>
