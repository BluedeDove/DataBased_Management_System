...
export interface ElectronAPI {
  ...
  reader: {
    ...
    regexSearch: (pattern: string, fields?: string[], searchMode?: 'contains' | 'exact' | 'startsWith' | 'endsWith' | 'regex') => Promise<any>
  ...
  book: {
    ...
    regexSearch: (pattern: string, fields?: string[], categoryId?: number | null, searchMode?: 'contains' | 'exact' | 'startsWith' | 'endsWith' | 'regex') => Promise<any>
...
const api: ElectronAPI = {
  ...
  reader: {
    ...
    regexSearch: (pattern, fields, searchMode) => ipcRenderer.invoke('reader:regexSearch', pattern, fields, searchMode),
  ...
  book: {
    ...
    regexSearch: (pattern, fields, categoryId, searchMode) => ipcRenderer.invoke('book:regexSearch', pattern, fields, categoryId, searchMode),
